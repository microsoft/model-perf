...
project = 'Performance 101'
copyright = '2023, Substrate AI Platform(STCA), Microsoft'
author = 'Lu Ye'
...
def process_signature(app, what, name, obj, options, signature, return_annotation):  
    ...
    if isinstance(return_annotation, str):
        return_annotation = return_annotation.replace("pyis.python.lib.pyis_python.ops", "ops")
